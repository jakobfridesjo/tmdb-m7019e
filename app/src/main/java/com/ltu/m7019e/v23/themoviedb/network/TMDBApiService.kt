...
private val movieDetailsRetrofit = Retrofit.Builder()
    .client(
        OkHttpClient.Builder()
            .addInterceptor(getLoggerIntercepter())
            .connectTimeout(20, TimeUnit.SECONDS)
...
private val videoListRetrofit = Retrofit.Builder()
    .client(
        OkHttpClient.Builder()
            .addInterceptor(getLoggerIntercepter())
            .connectTimeout(20, TimeUnit.SECONDS)
...
object TMDBApi {
    ...
    val movieDetailsRetrofitService: TMDBApiService by lazy { movieListRetrofit.create(TMDBApiService::class.java)}
    val reviewListRetrofitService: TMDBApiService by lazy { reviewListRetrofit.create(TMDBApiService::class.java)}
    val videoListRetrofitService: TMDBApiService by lazy { videoListRetrofit.create(TMDBApiService::class.java)}
}
